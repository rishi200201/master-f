              ...
              <div className="row">
                    ...
                    <div className="service-details-content">
                      ...
                      <div className="serivce-details-desc">
                        <p>
                          ...
                          transparent <span>technologies </span> whereas timely
                ...
                <div className="col-lg-12">
                  <div className="service-details-content">
                    ...
                    <div className="serivce-details-desc">
                      <p className="pb-35">
                        Collaboratively provide access to an expanded array 248
                        Engine via timely leadership. Enthusiastically evolve
                        transparent technologies whereas timely functionalities.
                        Continually repurpose e-business information and
                        prospective intellectual capital. Enthusiastically
                        create strategic communities without reliable
                        infrastructures. Holisticly embrace professional
                  ...
                  <div className="service-details-icon-box">
                    ...
                    <div className="widget-service-details-icon">
                      <p>
                        ...
                        <span> Efficiently reintermediate pandemic engine</span>
                      </p>
                      <p>
                        <i className="bi bi-check-lg" />{" "}
                        <span>
