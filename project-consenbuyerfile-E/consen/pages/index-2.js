          ...
          <div className="row align-items-center">
            <div className="col-lg-120">
              <div className="slider-content">
                <h1> HUMAN RESOURCE AND MANAGEMENT  </h1>
                <h1>
                  {" "}
                   <span>WHAT WE DO!</span>{" "}
                </h1>
                <p>
                Managing and supporting all HR and Employment processes
                </p>
              </div>
              ...
              <div className="single-feature-box">
                <div className="">
                  ...
                  <div className="feature-text">
                    <p>
                      {" "}
                      We provide HRM services that help businesses reduce cost, enhance employee satisfaction and improve the overall delivery of HR strategies.{" "}
                    </p>
                  </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-feature-box uppp-1">
                <div className="">
                  ...
                  <div className="feature-title">
                    <h3> Payroll and compliance services</h3>
                  </div>
                  <div className="feature-text">
                    <p>
                      {" "}
                      We provide customised payroll solutions that look after every aspect of your Payroll, Tax and Compliance.{" "}
                    </p>
                  </div>
                  <div className="feature-bar" />
                </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-feature-box uppp-1">
                <div className="">
                  ...
                  <div className="feature-title">
                    <h3> Assessment, Training and Placement </h3>
                  </div>
                  <div className="feature-text">
                    <p>
                      {" "}
                      We help in designing the perfect Assessment, Training and Placement program for your employees, supervisors, managers, and executive leadership.{" "}
                    </p>
                  </div>
                  <div className="feature-bar" />
                </div>
              ...
              <div className="single-feature-box uppp-1">
                <div className="">
                  ...
                  <div className="feature-title">
                    <h3> HR Process Consulting </h3>
                  </div>
                  <div className="feature-text">
                    <p>
                      {" "}
                      We develop concepts, process and standards, demonstrate ideal HR processes and help you put future-oriented HR management into practice{" "}
                    </p>
                  </div>
                  <div className="feature-bar" />
                </div>
      ...
      <div className="col-lg-6 col-md-12">
        <div className="-section-title">
          ...
          <p className="about-text1">
            We transform HR into a Revenue-Impact Function to improve your business capabilities.
          </p> */}
        </div>
          ...
          <div className="dreamit-icon-list">
            <ul>
              <li>
                ...
                <span>Flexible and Customized</span>
              </li>
              <li>
                <i className="bi bi-arrow-right-circle" />{" "}
                <span>
                  We believe that custom solution flexibility and integration is
                  better than the “one size fits all” rule.
                </span>
              </li>
              <li>
                <i className="bi bi-arrow-right-circle" />{" "}
                <span>Effective Recruitment</span>
              </li>
              <li>
                <i className="bi bi-arrow-right-circle" />{" "}
                <span>
                  We provide a set of flexible, cost-effective hiring solutions
                  to businesses in different niches.
                </span>
              </li>
              <li>
                <i className="bi bi-arrow-right-circle" />{" "}
              ...
              <li>
                <i className="bi bi-arrow-right-circle" />{" "}
                <span>
                  A fresh perspective, curiosity, and observations to create and
                  implement key strategies and shape the structure and
        ...
        {/* progress bars with updated values */}
        <div className="progress-box">
          <ProgressBar value={80} />
          <div className="circle-progress-title">
            <h4>
              {" "}
              Reduced <br /> Paperwork{" "}
            </h4>
          </div>
            ...
            <div className="col-lg-6">
              ...
              <div className="dreamit-icon-list">
                <ul>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>  Estab­lish­ing and Ex­pan­ding </span>
                   <p className="choose-text1"> We transform HR into a Revenue-Impact Function to improve your business capabilities.</p>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span> Flexible and Customized</span>
                    <p className="choose-text1">We believe that custom solution flexibility and integration is better than the “one size fits all” rule.</p>

                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>
                    Effective Recruitment </span>
                    <p className="choose-text1"> We provide a set of flexible, cost-effective hiring solutions to businesses in different niches.</p>

                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span> A fresh perspective </span>
                    <p className="choose-text1"> A fresh perspective, curiosity and observations to create and implement key strategies and shape the structure and functioning of your organisation.</p>
