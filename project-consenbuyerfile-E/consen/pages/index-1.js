          ...
          <div className="row align-items-center">
            <div className="col-lg-120">
              <div className="slider-content">
                <h1> Global Business Management and Strategy  </h1>
                <h1>
                  {" "}
              ...
              <div className="dreamit-icon-list">
                <ul>
                  <li>
                   ...
                   <p className="choose-text1"> WGet our expertise and views on business growth and cutting edge technology.</p>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>  Make informed decisions</span>
                    <p className="choose-text1">We’ve outlined decision-making business techniques that will help you weigh your options.</p>
                  ...
                  <li>
                    ...
                    <p className="choose-text1">We innovate by introducing new technology, techniques or working practices.
                  ...
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>  Strategic management expertise</span>
                    <p className="choose-text1"> We have the expertise you need to create and implement key strategies and shape the structure and functioning of your firm.
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="-section-title upper text-center mb-40">
          ...
          <h2>
          Business Management  <span>Strategy</span> 
          </h2>
        </div>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-6">
        <div className="single-service-box">
          ...
          <div className="service-content">
            <h2>Business Management & Strategy</h2>
            <p>
            We bring together the best practices, process improvements, and modern technologies to position your company ahead of its competition with better execution.
            </p>
            {/* <Link legacyBehavior href="/service">
              <a>Read More</a>
            </Link> */}
      ...
      <div className="col-lg-4 col-md-6">
        <div className="single-service-box">
          ...
          <div className="service-content">
            <h2>
            Process Design & Improvements</h2>
            <p>
            We help you execute improvements, including standardization and process automation
            </p>
            {/* <Link legacyBehavior href="/service">
              <a>Read More</a>
            </Link> */}
      ...
      <div className="col-lg-4 col-md-6">
        <div className="single-service-box">
          ...
          <div className="service-content">
            ...
            <p>
            We deliver business integration services, focusing on creating new business values, and improving business infrastructure.
            </p>
