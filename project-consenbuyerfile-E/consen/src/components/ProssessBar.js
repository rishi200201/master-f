const ProssessBar = () => {
  return (
    <div className="prossess-ber-plugin pt-20">
      <span className="prosses-bar">Customer Satisfaction</span>
      ...
      <span className="prosses-bar">Risk Management</span>
      ...
      <span className="prosses-bar">Quality Improvements</span>
      ...
      <span className="prosses-bar">Organisational Efficiency</span>
      <div id="bar3" className="barfiller">
        <div className="tipWrap" style={{ display: "inline" }}>
          <span
            className="tip"
