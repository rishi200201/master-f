            ...
            <div className="col-lg-8 col-sm-8">
              <div className="header_top_menu_address">
                <div className="header_top_menu_text">
                  <p>Welcome! to The Masterminds Internationals</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-3">
              <div className="logo">
                <Link legacyBehavior href="/">
                  <a className="logo_img" title="mmg">
              ...
              <div className="sidebar-info-contents">
                <div className="content-inner">
                  ...
                  <div className="content-box">
                   ...
                   The Masterminds International offers top-notch instructor-led and self-paced training courses, industry certifications, and business strategies. Our programs include Global Business Management, Human Resource Management, ISO Certifications, and more. We help organizations cut costs, enhance customer satisfaction, manage risk, and boost operations. Designed by experts, our courses equip you with the skills employers need today and tomorrow.
